...
"56x^7", the first number 56 being the product of the two numbers, and the second number being 
...
function derive(coefficient,exponent) {
    let multiple = coefficient * exponent
    let exponentMinusOne = exponent - 1
    return `${multiple}x^${exponentMinusOne}`
  }